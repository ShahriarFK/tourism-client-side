      ...
      <div className="container flex flex-col items-center justify-center px-5 mx-auto my-8">
        <div className="max-w-md text-center">
          <h2 className="mb-8 font-extrabold text-9xl dark:text-coolGray-600">
            <span className="sr-only">Error</span><span className=" text-yellow-500">404</span>
          </h2>
          ...
          <button
            ...
            href="/"
            className="px-8 py-3 text-yellow-500 font-semibold rounded dark:bg-violet-400 dark:text-coolGray-900"
          >
            Back to homepage
          </button>
        </div>
